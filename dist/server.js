        ...
        tools: [
            {
                ...
                description: "Search GitHub code for existing implementations of a feature/problem and return relevant files.",
                inputSchema: {
                    type: "object",
                    properties: {
                        problem: {
                            type: "string",
                            description: "Feature or problem statement to search for (for example: oauth token refresh middleware).",
                        },
                        language: {
                            type: "string",
            ...
            },
            {
                ...
                description: "Analyze GitHub implementations and suggest reusable code patterns with concrete examples.",
                inputSchema: {
                    type: "object",
                    properties: {
                        problem: {
